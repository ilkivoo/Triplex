...
init_full_help_array(void)
{
  ...
  RNAcofold_args_info_full_help[9] = RNAcofold_args_info_detailed_help[9];
  ...
  RNAcofold_args_info_full_help[19] = RNAcofold_args_info_detailed_help[28];
  RNAcofold_args_info_full_help[20] = RNAcofold_args_info_detailed_help[29];
  RNAcofold_args_info_full_help[21] = RNAcofold_args_info_detailed_help[30];
  RNAcofold_args_info_full_help[22] = RNAcofold_args_info_detailed_help[31];
  RNAcofold_args_info_full_help[23] = RNAcofold_args_info_detailed_help[33];
  ...
  RNAcofold_args_info_full_help[39] = RNAcofold_args_info_detailed_help[59];
  RNAcofold_args_info_full_help[40] = RNAcofold_args_info_detailed_help[60];
  RNAcofold_args_info_full_help[41] = RNAcofold_args_info_detailed_help[61];
  RNAcofold_args_info_full_help[42] = RNAcofold_args_info_detailed_help[63];
  RNAcofold_args_info_full_help[43] = RNAcofold_args_info_detailed_help[65];
  RNAcofold_args_info_full_help[44] = RNAcofold_args_info_detailed_help[67];
  RNAcofold_args_info_full_help[45] = RNAcofold_args_info_detailed_help[68];
  RNAcofold_args_info_full_help[46] = RNAcofold_args_info_detailed_help[69];
  RNAcofold_args_info_full_help[47] = RNAcofold_args_info_detailed_help[71];
  RNAcofold_args_info_full_help[48] = RNAcofold_args_info_detailed_help[73];
  RNAcofold_args_info_full_help[49] = RNAcofold_args_info_detailed_help[74];
  RNAcofold_args_info_full_help[50] = RNAcofold_args_info_detailed_help[76];
  RNAcofold_args_info_full_help[51] = 0; 
  
}

const char *RNAcofold_args_info_full_help[52];
...
init_help_array(void)
{
  ...
  RNAcofold_args_info_help[9] = RNAcofold_args_info_detailed_help[9];
  RNAcofold_args_info_help[10] = RNAcofold_args_info_detailed_help[11];
  RNAcofold_args_info_help[11] = RNAcofold_args_info_detailed_help[28];
  RNAcofold_args_info_help[12] = RNAcofold_args_info_detailed_help[29];
  RNAcofold_args_info_help[13] = RNAcofold_args_info_detailed_help[30];
  RNAcofold_args_info_help[14] = RNAcofold_args_info_detailed_help[31];
  RNAcofold_args_info_help[15] = RNAcofold_args_info_detailed_help[33];
  RNAcofold_args_info_help[16] = RNAcofold_args_info_detailed_help[35];
  RNAcofold_args_info_help[17] = RNAcofold_args_info_detailed_help[36];
  RNAcofold_args_info_help[18] = RNAcofold_args_info_detailed_help[37];
  RNAcofold_args_info_help[19] = RNAcofold_args_info_detailed_help[38];
  RNAcofold_args_info_help[20] = RNAcofold_args_info_detailed_help[40];
  RNAcofold_args_info_help[21] = RNAcofold_args_info_detailed_help[44];
  RNAcofold_args_info_help[22] = RNAcofold_args_info_detailed_help[45];
  RNAcofold_args_info_help[23] = RNAcofold_args_info_detailed_help[46];
  RNAcofold_args_info_help[24] = RNAcofold_args_info_detailed_help[48];
  RNAcofold_args_info_help[25] = RNAcofold_args_info_detailed_help[50];
  RNAcofold_args_info_help[26] = RNAcofold_args_info_detailed_help[52];
  RNAcofold_args_info_help[27] = RNAcofold_args_info_detailed_help[58];
  RNAcofold_args_info_help[28] = RNAcofold_args_info_detailed_help[59];
  RNAcofold_args_info_help[29] = RNAcofold_args_info_detailed_help[60];
  RNAcofold_args_info_help[30] = RNAcofold_args_info_detailed_help[61];
  RNAcofold_args_info_help[31] = RNAcofold_args_info_detailed_help[63];
  RNAcofold_args_info_help[32] = RNAcofold_args_info_detailed_help[65];
  RNAcofold_args_info_help[33] = RNAcofold_args_info_detailed_help[67];
  RNAcofold_args_info_help[34] = RNAcofold_args_info_detailed_help[68];
  RNAcofold_args_info_help[35] = RNAcofold_args_info_detailed_help[69];
  RNAcofold_args_info_help[36] = RNAcofold_args_info_detailed_help[76];
  RNAcofold_args_info_help[37] = 0; 
  
}

const char *RNAcofold_args_info_help[38];
...
void init_args_info(struct RNAcofold_args_info *args_info)
{
  ...
  args_info->noPS_help = RNAcofold_args_info_detailed_help[7] ;
  args_info->noconv_help = RNAcofold_args_info_detailed_help[8] ;
  args_info->auto_id_help = RNAcofold_args_info_detailed_help[9] ;
  args_info->id_prefix_help = RNAcofold_args_info_detailed_help[11] ;
  args_info->id_delim_help = RNAcofold_args_info_detailed_help[13] ;
  args_info->id_digits_help = RNAcofold_args_info_detailed_help[15] ;
  args_info->id_start_help = RNAcofold_args_info_detailed_help[17] ;
  args_info->filename_delim_help = RNAcofold_args_info_detailed_help[19] ;
  args_info->filename_full_help = RNAcofold_args_info_detailed_help[21] ;
  args_info->output_format_help = RNAcofold_args_info_detailed_help[23] ;
  args_info->csv_delim_help = RNAcofold_args_info_detailed_help[25] ;
  args_info->csv_noheader_help = RNAcofold_args_info_detailed_help[27] ;
  args_info->maxBPspan_help = RNAcofold_args_info_detailed_help[30] ;
  args_info->constraint_help = RNAcofold_args_info_detailed_help[31] ;
  args_info->batch_help = RNAcofold_args_info_detailed_help[33] ;
  args_info->canonicalBPonly_help = RNAcofold_args_info_detailed_help[35] ;
  args_info->enforceConstraint_help = RNAcofold_args_info_detailed_help[36] ;
  args_info->shape_help = RNAcofold_args_info_detailed_help[37] ;
  args_info->shapeMethod_help = RNAcofold_args_info_detailed_help[38] ;
  args_info->shapeConversion_help = RNAcofold_args_info_detailed_help[40] ;
  args_info->commands_help = RNAcofold_args_info_detailed_help[42] ;
  args_info->partfunc_help = RNAcofold_args_info_detailed_help[46] ;
  args_info->all_pf_help = RNAcofold_args_info_detailed_help[48] ;
  args_info->concentrations_help = RNAcofold_args_info_detailed_help[50] ;
  args_info->concfile_help = RNAcofold_args_info_detailed_help[52] ;
  args_info->pfScale_help = RNAcofold_args_info_detailed_help[54] ;
  args_info->bppmThreshold_help = RNAcofold_args_info_detailed_help[56] ;
  args_info->gquad_help = RNAcofold_args_info_detailed_help[58] ;
  args_info->temp_help = RNAcofold_args_info_detailed_help[60] ;
  args_info->noTetra_help = RNAcofold_args_info_detailed_help[61] ;
  args_info->dangles_help = RNAcofold_args_info_detailed_help[63] ;
  args_info->noLP_help = RNAcofold_args_info_detailed_help[65] ;
  args_info->noGU_help = RNAcofold_args_info_detailed_help[67] ;
  args_info->noClosingGU_help = RNAcofold_args_info_detailed_help[68] ;
  args_info->paramFile_help = RNAcofold_args_info_detailed_help[69] ;
  args_info->nsp_help = RNAcofold_args_info_detailed_help[71] ;
  args_info->energyModel_help = RNAcofold_args_info_detailed_help[73] ;
  args_info->betaScale_help = RNAcofold_args_info_detailed_help[74] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvC::p::a::cf:S:gT:4d:P:e:", long_options, &option_index);
