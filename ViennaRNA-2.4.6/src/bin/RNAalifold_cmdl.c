...
init_full_help_array(void)
{
  ...
  RNAalifold_args_info_full_help[15] = RNAalifold_args_info_detailed_help[17];
  RNAalifold_args_info_full_help[16] = RNAalifold_args_info_detailed_help[19];
  RNAalifold_args_info_full_help[17] = RNAalifold_args_info_detailed_help[21];
  RNAalifold_args_info_full_help[18] = RNAalifold_args_info_detailed_help[23];
  RNAalifold_args_info_full_help[19] = RNAalifold_args_info_detailed_help[25];
  RNAalifold_args_info_full_help[20] = RNAalifold_args_info_detailed_help[27];
  RNAalifold_args_info_full_help[21] = RNAalifold_args_info_detailed_help[29];
  RNAalifold_args_info_full_help[22] = RNAalifold_args_info_detailed_help[31];
  RNAalifold_args_info_full_help[23] = RNAalifold_args_info_detailed_help[33];
  ...
  RNAalifold_args_info_full_help[26] = RNAalifold_args_info_detailed_help[36];
  ...
  RNAalifold_args_info_full_help[33] = RNAalifold_args_info_detailed_help[48];
  RNAalifold_args_info_full_help[34] = RNAalifold_args_info_detailed_help[49];
  ...
  RNAalifold_args_info_full_help[38] = RNAalifold_args_info_detailed_help[55];
  RNAalifold_args_info_full_help[39] = RNAalifold_args_info_detailed_help[56];
  ...
  RNAalifold_args_info_full_help[43] = RNAalifold_args_info_detailed_help[62];
  RNAalifold_args_info_full_help[44] = RNAalifold_args_info_detailed_help[63];
  RNAalifold_args_info_full_help[45] = RNAalifold_args_info_detailed_help[64];
  ...
  RNAalifold_args_info_full_help[48] = RNAalifold_args_info_detailed_help[69];
  RNAalifold_args_info_full_help[49] = RNAalifold_args_info_detailed_help[71];
  RNAalifold_args_info_full_help[50] = RNAalifold_args_info_detailed_help[72];
  RNAalifold_args_info_full_help[51] = RNAalifold_args_info_detailed_help[73];
  RNAalifold_args_info_full_help[52] = RNAalifold_args_info_detailed_help[74];
  RNAalifold_args_info_full_help[53] = RNAalifold_args_info_detailed_help[75];
  RNAalifold_args_info_full_help[54] = RNAalifold_args_info_detailed_help[76];
  RNAalifold_args_info_full_help[55] = RNAalifold_args_info_detailed_help[77];
  RNAalifold_args_info_full_help[56] = RNAalifold_args_info_detailed_help[78];
  RNAalifold_args_info_full_help[57] = RNAalifold_args_info_detailed_help[79];
  RNAalifold_args_info_full_help[58] = RNAalifold_args_info_detailed_help[81];
  RNAalifold_args_info_full_help[59] = RNAalifold_args_info_detailed_help[83];
  RNAalifold_args_info_full_help[60] = RNAalifold_args_info_detailed_help[84];
  RNAalifold_args_info_full_help[61] = RNAalifold_args_info_detailed_help[86];
  RNAalifold_args_info_full_help[62] = 0; 
  
}

const char *RNAalifold_args_info_full_help[63];
...
init_help_array(void)
{
  ...
  RNAalifold_args_info_help[12] = RNAalifold_args_info_detailed_help[16];
  RNAalifold_args_info_help[13] = RNAalifold_args_info_detailed_help[17];
  RNAalifold_args_info_help[14] = RNAalifold_args_info_detailed_help[19];
  RNAalifold_args_info_help[15] = RNAalifold_args_info_detailed_help[21];
  RNAalifold_args_info_help[16] = RNAalifold_args_info_detailed_help[23];
  RNAalifold_args_info_help[17] = RNAalifold_args_info_detailed_help[33];
  RNAalifold_args_info_help[18] = RNAalifold_args_info_detailed_help[34];
  RNAalifold_args_info_help[19] = RNAalifold_args_info_detailed_help[35];
  RNAalifold_args_info_help[20] = RNAalifold_args_info_detailed_help[36];
  RNAalifold_args_info_help[21] = RNAalifold_args_info_detailed_help[38];
  RNAalifold_args_info_help[22] = RNAalifold_args_info_detailed_help[40];
  RNAalifold_args_info_help[23] = RNAalifold_args_info_detailed_help[41];
  RNAalifold_args_info_help[24] = RNAalifold_args_info_detailed_help[43];
  RNAalifold_args_info_help[25] = RNAalifold_args_info_detailed_help[45];
  RNAalifold_args_info_help[26] = RNAalifold_args_info_detailed_help[47];
  RNAalifold_args_info_help[27] = RNAalifold_args_info_detailed_help[48];
  RNAalifold_args_info_help[28] = RNAalifold_args_info_detailed_help[49];
  RNAalifold_args_info_help[29] = RNAalifold_args_info_detailed_help[51];
  RNAalifold_args_info_help[30] = RNAalifold_args_info_detailed_help[53];
  RNAalifold_args_info_help[31] = RNAalifold_args_info_detailed_help[54];
  RNAalifold_args_info_help[32] = RNAalifold_args_info_detailed_help[55];
  RNAalifold_args_info_help[33] = RNAalifold_args_info_detailed_help[58];
  RNAalifold_args_info_help[34] = RNAalifold_args_info_detailed_help[61];
  RNAalifold_args_info_help[35] = RNAalifold_args_info_detailed_help[62];
  RNAalifold_args_info_help[36] = RNAalifold_args_info_detailed_help[63];
  RNAalifold_args_info_help[37] = RNAalifold_args_info_detailed_help[64];
  RNAalifold_args_info_help[38] = RNAalifold_args_info_detailed_help[65];
  RNAalifold_args_info_help[39] = RNAalifold_args_info_detailed_help[67];
  RNAalifold_args_info_help[40] = RNAalifold_args_info_detailed_help[69];
  RNAalifold_args_info_help[41] = RNAalifold_args_info_detailed_help[71];
  RNAalifold_args_info_help[42] = RNAalifold_args_info_detailed_help[72];
  RNAalifold_args_info_help[43] = RNAalifold_args_info_detailed_help[73];
  RNAalifold_args_info_help[44] = RNAalifold_args_info_detailed_help[74];
  RNAalifold_args_info_help[45] = RNAalifold_args_info_detailed_help[75];
  RNAalifold_args_info_help[46] = RNAalifold_args_info_detailed_help[76];
  RNAalifold_args_info_help[47] = RNAalifold_args_info_detailed_help[77];
  RNAalifold_args_info_help[48] = RNAalifold_args_info_detailed_help[78];
  RNAalifold_args_info_help[49] = RNAalifold_args_info_detailed_help[79];
  RNAalifold_args_info_help[50] = RNAalifold_args_info_detailed_help[86];
  RNAalifold_args_info_help[51] = 0; 
  
}

const char *RNAalifold_args_info_help[52];
...
void init_args_info(struct RNAalifold_args_info *args_info)
{
  ...
  args_info->noconv_help = RNAalifold_args_info_detailed_help[9] ;
  args_info->color_help = RNAalifold_args_info_detailed_help[10] ;
  args_info->aln_help = RNAalifold_args_info_detailed_help[11] ;
  args_info->aln_EPS_cols_help = RNAalifold_args_info_detailed_help[12] ;
  args_info->aln_stk_help = RNAalifold_args_info_detailed_help[13] ;
  args_info->layout_type_help = RNAalifold_args_info_detailed_help[15] ;
  args_info->noPS_help = RNAalifold_args_info_detailed_help[16] ;
  args_info->input_format_help = RNAalifold_args_info_detailed_help[17] ;
  args_info->continuous_ids_help = RNAalifold_args_info_detailed_help[19] ;
  args_info->auto_id_help = RNAalifold_args_info_detailed_help[21] ;
  args_info->id_prefix_help = RNAalifold_args_info_detailed_help[23] ;
  args_info->id_delim_help = RNAalifold_args_info_detailed_help[25] ;
  args_info->id_digits_help = RNAalifold_args_info_detailed_help[27] ;
  args_info->id_start_help = RNAalifold_args_info_detailed_help[29] ;
  args_info->filename_delim_help = RNAalifold_args_info_detailed_help[31] ;
  args_info->maxBPspan_help = RNAalifold_args_info_detailed_help[35] ;
  args_info->constraint_help = RNAalifold_args_info_detailed_help[36] ;
  args_info->batch_help = RNAalifold_args_info_detailed_help[38] ;
  args_info->enforceConstraint_help = RNAalifold_args_info_detailed_help[40] ;
  args_info->SS_cons_help = RNAalifold_args_info_detailed_help[41] ;
  args_info->shape_help = RNAalifold_args_info_detailed_help[43] ;
  args_info->shape_min = 1;
  args_info->shape_max = 0;
  args_info->shapeMethod_help = RNAalifold_args_info_detailed_help[45] ;
  args_info->partfunc_help = RNAalifold_args_info_detailed_help[49] ;
  args_info->MEA_help = RNAalifold_args_info_detailed_help[51] ;
  args_info->mis_help = RNAalifold_args_info_detailed_help[53] ;
  args_info->stochBT_help = RNAalifold_args_info_detailed_help[54] ;
  args_info->stochBT_en_help = RNAalifold_args_info_detailed_help[55] ;
  args_info->pfScale_help = RNAalifold_args_info_detailed_help[56] ;
  args_info->circ_help = RNAalifold_args_info_detailed_help[58] ;
  args_info->bppmThreshold_help = RNAalifold_args_info_detailed_help[59] ;
  args_info->gquad_help = RNAalifold_args_info_detailed_help[61] ;
  args_info->sci_help = RNAalifold_args_info_detailed_help[62] ;
  args_info->temp_help = RNAalifold_args_info_detailed_help[64] ;
  args_info->noTetra_help = RNAalifold_args_info_detailed_help[65] ;
  args_info->dangles_help = RNAalifold_args_info_detailed_help[67] ;
  args_info->noLP_help = RNAalifold_args_info_detailed_help[69] ;
  args_info->noGU_help = RNAalifold_args_info_detailed_help[71] ;
  args_info->noClosingGU_help = RNAalifold_args_info_detailed_help[72] ;
  args_info->cfactor_help = RNAalifold_args_info_detailed_help[73] ;
  args_info->nfactor_help = RNAalifold_args_info_detailed_help[74] ;
  args_info->endgaps_help = RNAalifold_args_info_detailed_help[75] ;
  args_info->ribosum_file_help = RNAalifold_args_info_detailed_help[76] ;
  args_info->ribosum_scoring_help = RNAalifold_args_info_detailed_help[77] ;
  args_info->old_help = RNAalifold_args_info_detailed_help[78] ;
  args_info->paramFile_help = RNAalifold_args_info_detailed_help[79] ;
  args_info->nsp_help = RNAalifold_args_info_detailed_help[81] ;
  args_info->energyModel_help = RNAalifold_args_info_detailed_help[83] ;
  args_info->betaScale_help = RNAalifold_args_info_detailed_help[84] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvqt:f:nC::p::s:S:cgT:4d:ER:rP:e:", long_options, &option_index);
