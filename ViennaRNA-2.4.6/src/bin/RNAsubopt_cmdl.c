...
init_full_help_array(void)
{
  ...
  RNAsubopt_args_info_full_help[28] = RNAsubopt_args_info_detailed_help[41];
  RNAsubopt_args_info_full_help[29] = RNAsubopt_args_info_detailed_help[42];
  RNAsubopt_args_info_full_help[30] = RNAsubopt_args_info_detailed_help[43];
  ...
  RNAsubopt_args_info_full_help[33] = RNAsubopt_args_info_detailed_help[48];
  RNAsubopt_args_info_full_help[34] = RNAsubopt_args_info_detailed_help[49];
  ...
  RNAsubopt_args_info_full_help[39] = RNAsubopt_args_info_detailed_help[56];
  RNAsubopt_args_info_full_help[40] = RNAsubopt_args_info_detailed_help[57];
  RNAsubopt_args_info_full_help[41] = RNAsubopt_args_info_detailed_help[58];
  RNAsubopt_args_info_full_help[42] = RNAsubopt_args_info_detailed_help[60];
  RNAsubopt_args_info_full_help[43] = RNAsubopt_args_info_detailed_help[62];
  RNAsubopt_args_info_full_help[44] = RNAsubopt_args_info_detailed_help[64];
  RNAsubopt_args_info_full_help[45] = RNAsubopt_args_info_detailed_help[65];
  RNAsubopt_args_info_full_help[46] = RNAsubopt_args_info_detailed_help[66];
  RNAsubopt_args_info_full_help[47] = RNAsubopt_args_info_detailed_help[68];
  RNAsubopt_args_info_full_help[48] = RNAsubopt_args_info_detailed_help[70];
  RNAsubopt_args_info_full_help[49] = RNAsubopt_args_info_detailed_help[72];
  ...
  RNAsubopt_args_info_full_help[52] = 0; 
  
}

const char *RNAsubopt_args_info_full_help[53];
...
init_help_array(void)
{
  ...
  RNAsubopt_args_info_help[22] = RNAsubopt_args_info_detailed_help[40];
  RNAsubopt_args_info_help[23] = RNAsubopt_args_info_detailed_help[41];
  RNAsubopt_args_info_help[24] = RNAsubopt_args_info_detailed_help[42];
  RNAsubopt_args_info_help[25] = RNAsubopt_args_info_detailed_help[43];
  RNAsubopt_args_info_help[26] = RNAsubopt_args_info_detailed_help[45];
  RNAsubopt_args_info_help[27] = RNAsubopt_args_info_detailed_help[47];
  RNAsubopt_args_info_help[28] = RNAsubopt_args_info_detailed_help[48];
  RNAsubopt_args_info_help[29] = RNAsubopt_args_info_detailed_help[51];
  RNAsubopt_args_info_help[30] = RNAsubopt_args_info_detailed_help[52];
  RNAsubopt_args_info_help[31] = RNAsubopt_args_info_detailed_help[54];
  RNAsubopt_args_info_help[32] = RNAsubopt_args_info_detailed_help[55];
  RNAsubopt_args_info_help[33] = RNAsubopt_args_info_detailed_help[56];
  RNAsubopt_args_info_help[34] = RNAsubopt_args_info_detailed_help[57];
  RNAsubopt_args_info_help[35] = RNAsubopt_args_info_detailed_help[58];
  RNAsubopt_args_info_help[36] = RNAsubopt_args_info_detailed_help[60];
  RNAsubopt_args_info_help[37] = RNAsubopt_args_info_detailed_help[62];
  RNAsubopt_args_info_help[38] = RNAsubopt_args_info_detailed_help[64];
  RNAsubopt_args_info_help[39] = RNAsubopt_args_info_detailed_help[65];
  RNAsubopt_args_info_help[40] = RNAsubopt_args_info_detailed_help[66];
  RNAsubopt_args_info_help[41] = RNAsubopt_args_info_detailed_help[68];
  RNAsubopt_args_info_help[42] = RNAsubopt_args_info_detailed_help[75];
  RNAsubopt_args_info_help[43] = 0; 
  
}

const char *RNAsubopt_args_info_help[44];
...
void init_args_info(struct RNAsubopt_args_info *args_info)
{
  ...
  args_info->deltaEnergy_help = RNAsubopt_args_info_detailed_help[42] ;
  args_info->deltaEnergyPost_help = RNAsubopt_args_info_detailed_help[43] ;
  args_info->sorted_help = RNAsubopt_args_info_detailed_help[45] ;
  args_info->stochBT_help = RNAsubopt_args_info_detailed_help[47] ;
  args_info->stochBT_en_help = RNAsubopt_args_info_detailed_help[48] ;
  ...
  args_info->temp_help = RNAsubopt_args_info_detailed_help[57] ;
  args_info->noTetra_help = RNAsubopt_args_info_detailed_help[58] ;
  args_info->dangles_help = RNAsubopt_args_info_detailed_help[60] ;
  args_info->noLP_help = RNAsubopt_args_info_detailed_help[62] ;
  args_info->noGU_help = RNAsubopt_args_info_detailed_help[64] ;
  args_info->noClosingGU_help = RNAsubopt_args_info_detailed_help[65] ;
  args_info->logML_help = RNAsubopt_args_info_detailed_help[66] ;
  args_info->paramFile_help = RNAsubopt_args_info_detailed_help[68] ;
  args_info->nsp_help = RNAsubopt_args_info_detailed_help[70] ;
  args_info->energyModel_help = RNAsubopt_args_info_detailed_help[72] ;
  args_info->betaScale_help = RNAsubopt_args_info_detailed_help[73] ;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVvi:o::C::e:sp:S:cDzgT:4d:P:", long_options, &option_index);
