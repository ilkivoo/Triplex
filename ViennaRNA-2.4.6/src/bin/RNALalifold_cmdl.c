...
init_full_help_array(void)
{
  ...
  RNALalifold_args_info_full_help[14] = RNALalifold_args_info_detailed_help[18];
  ...
  RNALalifold_args_info_full_help[22] = RNALalifold_args_info_detailed_help[34];
  ...
  RNALalifold_args_info_full_help[26] = RNALalifold_args_info_detailed_help[40];
  RNALalifold_args_info_full_help[27] = RNALalifold_args_info_detailed_help[42];
  RNALalifold_args_info_full_help[28] = RNALalifold_args_info_detailed_help[43];
  RNALalifold_args_info_full_help[29] = RNALalifold_args_info_detailed_help[44];
  RNALalifold_args_info_full_help[30] = RNALalifold_args_info_detailed_help[45];
  RNALalifold_args_info_full_help[31] = RNALalifold_args_info_detailed_help[46];
  RNALalifold_args_info_full_help[32] = RNALalifold_args_info_detailed_help[47];
  RNALalifold_args_info_full_help[33] = RNALalifold_args_info_detailed_help[48];
  ...
  RNALalifold_args_info_full_help[37] = RNALalifold_args_info_detailed_help[53];
  RNALalifold_args_info_full_help[38] = RNALalifold_args_info_detailed_help[55];
  ...
  RNALalifold_args_info_full_help[43] = RNALalifold_args_info_detailed_help[62];
...
init_help_array(void)
{
  ...
  RNALalifold_args_info_help[15] = RNALalifold_args_info_detailed_help[22];
  RNALalifold_args_info_help[16] = RNALalifold_args_info_detailed_help[24];
  RNALalifold_args_info_help[17] = RNALalifold_args_info_detailed_help[34];
  RNALalifold_args_info_help[18] = RNALalifold_args_info_detailed_help[36];
  RNALalifold_args_info_help[19] = RNALalifold_args_info_detailed_help[37];
  RNALalifold_args_info_help[20] = RNALalifold_args_info_detailed_help[38];
  RNALalifold_args_info_help[21] = RNALalifold_args_info_detailed_help[40];
  RNALalifold_args_info_help[22] = RNALalifold_args_info_detailed_help[42];
  RNALalifold_args_info_help[23] = RNALalifold_args_info_detailed_help[43];
  RNALalifold_args_info_help[24] = RNALalifold_args_info_detailed_help[44];
  RNALalifold_args_info_help[25] = RNALalifold_args_info_detailed_help[45];
  RNALalifold_args_info_help[26] = RNALalifold_args_info_detailed_help[46];
  RNALalifold_args_info_help[27] = RNALalifold_args_info_detailed_help[47];
  RNALalifold_args_info_help[28] = RNALalifold_args_info_detailed_help[48];
  RNALalifold_args_info_help[29] = RNALalifold_args_info_detailed_help[49];
  RNALalifold_args_info_help[30] = RNALalifold_args_info_detailed_help[50];
  RNALalifold_args_info_help[31] = RNALalifold_args_info_detailed_help[51];
  ...
  RNALalifold_args_info_help[34] = RNALalifold_args_info_detailed_help[56];
  RNALalifold_args_info_help[35] = RNALalifold_args_info_detailed_help[57];
  RNALalifold_args_info_help[36] = RNALalifold_args_info_detailed_help[62];
  RNALalifold_args_info_help[37] = RNALalifold_args_info_detailed_help[63];
  RNALalifold_args_info_help[38] = RNALalifold_args_info_detailed_help[64];
  RNALalifold_args_info_help[39] = RNALalifold_args_info_detailed_help[65];
  RNALalifold_args_info_help[40] = RNALalifold_args_info_detailed_help[66];
...
void init_args_info(struct RNALalifold_args_info *args_info)
{
  ...
  args_info->aln_EPS_ss_help = RNALalifold_args_info_detailed_help[18] ;
  args_info->aln_stk_help = RNALalifold_args_info_detailed_help[20] ;
  args_info->auto_id_help = RNALalifold_args_info_detailed_help[22] ;
  args_info->id_prefix_help = RNALalifold_args_info_detailed_help[24] ;
  args_info->id_delim_help = RNALalifold_args_info_detailed_help[26] ;
  args_info->id_digits_help = RNALalifold_args_info_detailed_help[28] ;
  args_info->id_start_help = RNALalifold_args_info_detailed_help[30] ;
  args_info->filename_delim_help = RNALalifold_args_info_detailed_help[32] ;
  args_info->split_contributions_help = RNALalifold_args_info_detailed_help[34] ;
  args_info->shape_help = RNALalifold_args_info_detailed_help[38] ;
  args_info->shape_min = 1;
  args_info->shape_max = 0;
  args_info->shapeMethod_help = RNALalifold_args_info_detailed_help[40] ;
  args_info->maxBPspan_help = RNALalifold_args_info_detailed_help[44] ;
  args_info->threshold_help = RNALalifold_args_info_detailed_help[45] ;
  args_info->mis_help = RNALalifold_args_info_detailed_help[46] ;
  args_info->gquad_help = RNALalifold_args_info_detailed_help[47] ;
  args_info->temp_help = RNALalifold_args_info_detailed_help[49] ;
  args_info->noTetra_help = RNALalifold_args_info_detailed_help[50] ;
  args_info->dangles_help = RNALalifold_args_info_detailed_help[51] ;
  args_info->noLP_help = RNALalifold_args_info_detailed_help[53] ;
  args_info->noGU_help = RNALalifold_args_info_detailed_help[55] ;
  args_info->noClosingGU_help = RNALalifold_args_info_detailed_help[56] ;
  args_info->paramFile_help = RNALalifold_args_info_detailed_help[57] ;
  args_info->nsp_help = RNALalifold_args_info_detailed_help[59] ;
  args_info->energyModel_help = RNALalifold_args_info_detailed_help[61] ;
  args_info->cfactor_help = RNALalifold_args_info_detailed_help[62] ;
  args_info->nfactor_help = RNALalifold_args_info_detailed_help[63] ;
  args_info->ribosum_file_help = RNALalifold_args_info_detailed_help[64] ;
  args_info->ribosum_scoring_help = RNALalifold_args_info_detailed_help[65] ;
