...
const char *RNAfold_args_info_detailed_help[] = {
  ...
  "  Default processing of input data is performed in a serial fashion, i.e. one\n  sequence at a time. Using this switch, a user can instead start the\n  computation for many sequences in the input in parallel. RNAfold will create\n  as many parallel computation slots as specified and assigns input sequences\n  of an input file to the available slots. Note, that this increases memory\n  consumption since each jobs requires its own dynamic programming matrices.\n  Also note, that individual input files are still being processed\n  sequentially, i.e. sequences of the next input file have to wait for all\n  sequences of the current file to be finished. A value of 0 indicates to use\n  as many parallel threads as computation cores are available.\n\n",
...
init_full_help_array(void)
{
  ...
  RNAfold_args_info_full_help[13] = RNAfold_args_info_detailed_help[17];
  ...
  RNAfold_args_info_full_help[20] = RNAfold_args_info_detailed_help[30];
  RNAfold_args_info_full_help[21] = RNAfold_args_info_detailed_help[32];
  RNAfold_args_info_full_help[22] = RNAfold_args_info_detailed_help[33];
  RNAfold_args_info_full_help[23] = RNAfold_args_info_detailed_help[34];
  RNAfold_args_info_full_help[24] = RNAfold_args_info_detailed_help[35];
  RNAfold_args_info_full_help[25] = RNAfold_args_info_detailed_help[37];
  ...
  RNAfold_args_info_full_help[32] = RNAfold_args_info_detailed_help[48];
  RNAfold_args_info_full_help[33] = RNAfold_args_info_detailed_help[50];
  ...
  RNAfold_args_info_full_help[41] = RNAfold_args_info_detailed_help[63];
  RNAfold_args_info_full_help[42] = RNAfold_args_info_detailed_help[64];
  RNAfold_args_info_full_help[43] = RNAfold_args_info_detailed_help[65];
  ...
  RNAfold_args_info_full_help[46] = RNAfold_args_info_detailed_help[70];
  ...
  RNAfold_args_info_full_help[54] = 0; 
  
}

const char *RNAfold_args_info_full_help[55];
...
init_help_array(void)
{
  ...
  RNAfold_args_info_help[12] = RNAfold_args_info_detailed_help[17];
  ...
  RNAfold_args_info_help[16] = RNAfold_args_info_detailed_help[33];
  RNAfold_args_info_help[17] = RNAfold_args_info_detailed_help[34];
  RNAfold_args_info_help[18] = RNAfold_args_info_detailed_help[35];
  RNAfold_args_info_help[19] = RNAfold_args_info_detailed_help[37];
  RNAfold_args_info_help[20] = RNAfold_args_info_detailed_help[39];
  RNAfold_args_info_help[21] = RNAfold_args_info_detailed_help[40];
  RNAfold_args_info_help[22] = RNAfold_args_info_detailed_help[41];
  RNAfold_args_info_help[23] = RNAfold_args_info_detailed_help[42];
  RNAfold_args_info_help[24] = RNAfold_args_info_detailed_help[44];
  RNAfold_args_info_help[25] = RNAfold_args_info_detailed_help[50];
  RNAfold_args_info_help[26] = RNAfold_args_info_detailed_help[51];
  RNAfold_args_info_help[27] = RNAfold_args_info_detailed_help[52];
  RNAfold_args_info_help[28] = RNAfold_args_info_detailed_help[54];
  RNAfold_args_info_help[29] = RNAfold_args_info_detailed_help[58];
  RNAfold_args_info_help[30] = RNAfold_args_info_detailed_help[63];
  RNAfold_args_info_help[31] = RNAfold_args_info_detailed_help[64];
  RNAfold_args_info_help[32] = RNAfold_args_info_detailed_help[65];
  RNAfold_args_info_help[33] = RNAfold_args_info_detailed_help[66];
  RNAfold_args_info_help[34] = RNAfold_args_info_detailed_help[68];
  RNAfold_args_info_help[35] = RNAfold_args_info_detailed_help[70];
  RNAfold_args_info_help[36] = RNAfold_args_info_detailed_help[72];
  RNAfold_args_info_help[37] = RNAfold_args_info_detailed_help[73];
  RNAfold_args_info_help[38] = RNAfold_args_info_detailed_help[74];
  RNAfold_args_info_help[39] = RNAfold_args_info_detailed_help[81];
...
void init_args_info(struct RNAfold_args_info *args_info)
{
  ...
  args_info->noPS_help = RNAfold_args_info_detailed_help[16] ;
  args_info->noconv_help = RNAfold_args_info_detailed_help[17] ;
  args_info->auto_id_help = RNAfold_args_info_detailed_help[18] ;
  args_info->id_prefix_help = RNAfold_args_info_detailed_help[20] ;
  args_info->id_delim_help = RNAfold_args_info_detailed_help[22] ;
  args_info->id_digits_help = RNAfold_args_info_detailed_help[24] ;
  args_info->id_start_help = RNAfold_args_info_detailed_help[26] ;
  args_info->filename_delim_help = RNAfold_args_info_detailed_help[28] ;
  args_info->filename_full_help = RNAfold_args_info_detailed_help[30] ;
  args_info->maxBPspan_help = RNAfold_args_info_detailed_help[34] ;
  args_info->constraint_help = RNAfold_args_info_detailed_help[35] ;
  args_info->batch_help = RNAfold_args_info_detailed_help[37] ;
  args_info->canonicalBPonly_help = RNAfold_args_info_detailed_help[39] ;
  args_info->enforceConstraint_help = RNAfold_args_info_detailed_help[40] ;
  args_info->shape_help = RNAfold_args_info_detailed_help[41] ;
  args_info->shapeMethod_help = RNAfold_args_info_detailed_help[42] ;
  args_info->shapeConversion_help = RNAfold_args_info_detailed_help[44] ;
  args_info->motif_help = RNAfold_args_info_detailed_help[46] ;
  args_info->commands_help = RNAfold_args_info_detailed_help[48] ;
  args_info->partfunc_help = RNAfold_args_info_detailed_help[52] ;
  args_info->MEA_help = RNAfold_args_info_detailed_help[54] ;
  args_info->pfScale_help = RNAfold_args_info_detailed_help[56] ;
  args_info->circ_help = RNAfold_args_info_detailed_help[58] ;
  args_info->ImFeelingLucky_help = RNAfold_args_info_detailed_help[59] ;
  args_info->bppmThreshold_help = RNAfold_args_info_detailed_help[61] ;
  args_info->gquad_help = RNAfold_args_info_detailed_help[63] ;
  args_info->temp_help = RNAfold_args_info_detailed_help[65] ;
  args_info->noTetra_help = RNAfold_args_info_detailed_help[66] ;
  args_info->dangles_help = RNAfold_args_info_detailed_help[68] ;
  args_info->noLP_help = RNAfold_args_info_detailed_help[70] ;
  args_info->noGU_help = RNAfold_args_info_detailed_help[72] ;
  args_info->noClosingGU_help = RNAfold_args_info_detailed_help[73] ;
  args_info->paramFile_help = RNAfold_args_info_detailed_help[74] ;
  args_info->nsp_help = RNAfold_args_info_detailed_help[76] ;
  args_info->energyModel_help = RNAfold_args_info_detailed_help[78] ;
  args_info->betaScale_help = RNAfold_args_info_detailed_help[79] ;
