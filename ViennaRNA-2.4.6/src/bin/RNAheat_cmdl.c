...
init_full_help_array(void)
{
  ...
  RNAheat_args_info_full_help[17] = RNAheat_args_info_detailed_help[22];
  RNAheat_args_info_full_help[18] = RNAheat_args_info_detailed_help[23];
  RNAheat_args_info_full_help[19] = RNAheat_args_info_detailed_help[25];
  RNAheat_args_info_full_help[20] = RNAheat_args_info_detailed_help[27];
  RNAheat_args_info_full_help[21] = RNAheat_args_info_detailed_help[28];
  RNAheat_args_info_full_help[22] = RNAheat_args_info_detailed_help[29];
  RNAheat_args_info_full_help[23] = RNAheat_args_info_detailed_help[31];
  RNAheat_args_info_full_help[24] = RNAheat_args_info_detailed_help[33];
  RNAheat_args_info_full_help[25] = RNAheat_args_info_detailed_help[34];
  RNAheat_args_info_full_help[26] = 0; 
  
}

const char *RNAheat_args_info_full_help[27];
...
init_help_array(void)
{
  ...
  RNAheat_args_info_help[12] = RNAheat_args_info_detailed_help[13];
  RNAheat_args_info_help[13] = RNAheat_args_info_detailed_help[21];
  RNAheat_args_info_help[14] = RNAheat_args_info_detailed_help[22];
  RNAheat_args_info_help[15] = RNAheat_args_info_detailed_help[23];
  RNAheat_args_info_help[16] = RNAheat_args_info_detailed_help[25];
  RNAheat_args_info_help[17] = RNAheat_args_info_detailed_help[27];
  RNAheat_args_info_help[18] = RNAheat_args_info_detailed_help[28];
  RNAheat_args_info_help[19] = RNAheat_args_info_detailed_help[29];
  RNAheat_args_info_help[20] = RNAheat_args_info_detailed_help[34];
  RNAheat_args_info_help[21] = 0; 
  
}

const char *RNAheat_args_info_help[22];
...
void init_args_info(struct RNAheat_args_info *args_info)
{
  ...
  args_info->auto_id_help = RNAheat_args_info_detailed_help[11] ;
  args_info->id_prefix_help = RNAheat_args_info_detailed_help[13] ;
  args_info->id_delim_help = RNAheat_args_info_detailed_help[15] ;
  args_info->id_digits_help = RNAheat_args_info_detailed_help[17] ;
  args_info->id_start_help = RNAheat_args_info_detailed_help[19] ;
  args_info->noTetra_help = RNAheat_args_info_detailed_help[22] ;
  args_info->dangles_help = RNAheat_args_info_detailed_help[23] ;
  args_info->noLP_help = RNAheat_args_info_detailed_help[25] ;
  args_info->noGU_help = RNAheat_args_info_detailed_help[27] ;
  args_info->noClosingGU_help = RNAheat_args_info_detailed_help[28] ;
  args_info->paramFile_help = RNAheat_args_info_detailed_help[29] ;
  args_info->nsp_help = RNAheat_args_info_detailed_help[31] ;
  args_info->energyModel_help = RNAheat_args_info_detailed_help[33] ;
