...
const char *RNALfold_args_info_detailed_help[] = {
  ...
  "  -z, --zscore[=DOUBLE]         Activate z-score computation. An optional\n                                  argument may be supplied to set the threshold\n                                  Due to parsing the commandline parameters a\n                                  negative value should be given immediately\n                                  after \"z\" without spaces e.g. -z-4.9\n\n                                    (default=`-2')",
...
init_full_help_array(void)
{
  ...
  RNALfold_args_info_full_help[10] = RNALfold_args_info_detailed_help[11];
  RNALfold_args_info_full_help[11] = RNALfold_args_info_detailed_help[13];
  RNALfold_args_info_full_help[12] = RNALfold_args_info_detailed_help[15];
  RNALfold_args_info_full_help[13] = RNALfold_args_info_detailed_help[17];
  RNALfold_args_info_full_help[14] = RNALfold_args_info_detailed_help[19];
  RNALfold_args_info_full_help[15] = RNALfold_args_info_detailed_help[21];
  RNALfold_args_info_full_help[16] = RNALfold_args_info_detailed_help[23];
  RNALfold_args_info_full_help[17] = RNALfold_args_info_detailed_help[25];
  RNALfold_args_info_full_help[18] = RNALfold_args_info_detailed_help[27];
  RNALfold_args_info_full_help[19] = RNALfold_args_info_detailed_help[29];
  ...
  RNALfold_args_info_full_help[25] = RNALfold_args_info_detailed_help[37];
  RNALfold_args_info_full_help[26] = RNALfold_args_info_detailed_help[38];
  RNALfold_args_info_full_help[27] = RNALfold_args_info_detailed_help[39];
  RNALfold_args_info_full_help[28] = RNALfold_args_info_detailed_help[40];
  RNALfold_args_info_full_help[29] = RNALfold_args_info_detailed_help[41];
  RNALfold_args_info_full_help[30] = RNALfold_args_info_detailed_help[43];
  RNALfold_args_info_full_help[31] = RNALfold_args_info_detailed_help[45];
  RNALfold_args_info_full_help[32] = RNALfold_args_info_detailed_help[46];
  RNALfold_args_info_full_help[33] = RNALfold_args_info_detailed_help[47];
  RNALfold_args_info_full_help[34] = RNALfold_args_info_detailed_help[49];
  RNALfold_args_info_full_help[35] = RNALfold_args_info_detailed_help[51];
  RNALfold_args_info_full_help[36] = RNALfold_args_info_detailed_help[52];
  RNALfold_args_info_full_help[37] = 0; 
  
}

const char *RNALfold_args_info_full_help[38];
...
init_help_array(void)
{
  ...
  RNALfold_args_info_help[10] = RNALfold_args_info_detailed_help[11];
  RNALfold_args_info_help[11] = RNALfold_args_info_detailed_help[13];
  RNALfold_args_info_help[12] = RNALfold_args_info_detailed_help[15];
  RNALfold_args_info_help[13] = RNALfold_args_info_detailed_help[29];
  RNALfold_args_info_help[14] = RNALfold_args_info_detailed_help[30];
  RNALfold_args_info_help[15] = RNALfold_args_info_detailed_help[32];
  RNALfold_args_info_help[16] = RNALfold_args_info_detailed_help[34];
  RNALfold_args_info_help[17] = RNALfold_args_info_detailed_help[35];
  RNALfold_args_info_help[18] = RNALfold_args_info_detailed_help[36];
  RNALfold_args_info_help[19] = RNALfold_args_info_detailed_help[37];
  RNALfold_args_info_help[20] = RNALfold_args_info_detailed_help[38];
  RNALfold_args_info_help[21] = RNALfold_args_info_detailed_help[39];
  RNALfold_args_info_help[22] = RNALfold_args_info_detailed_help[40];
  RNALfold_args_info_help[23] = RNALfold_args_info_detailed_help[41];
  RNALfold_args_info_help[24] = RNALfold_args_info_detailed_help[43];
  RNALfold_args_info_help[25] = RNALfold_args_info_detailed_help[45];
  RNALfold_args_info_help[26] = RNALfold_args_info_detailed_help[46];
  RNALfold_args_info_help[27] = RNALfold_args_info_detailed_help[47];
  RNALfold_args_info_help[28] = RNALfold_args_info_detailed_help[52];
  RNALfold_args_info_help[29] = 0; 
  
}

const char *RNALfold_args_info_help[30];
...
void init_args_info(struct RNALfold_args_info *args_info)
{
  ...
  args_info->noconv_help = RNALfold_args_info_detailed_help[8] ;
  args_info->outfile_help = RNALfold_args_info_detailed_help[9] ;
  args_info->infile_help = RNALfold_args_info_detailed_help[11] ;
  ...
  args_info->commands_help = RNALfold_args_info_detailed_help[27] ;
  args_info->shape_help = RNALfold_args_info_detailed_help[29] ;
  args_info->shapeMethod_help = RNALfold_args_info_detailed_help[30] ;
  args_info->shapeConversion_help = RNALfold_args_info_detailed_help[32] ;
  args_info->zscore_help = RNALfold_args_info_detailed_help[36] ;
  args_info->gquad_help = RNALfold_args_info_detailed_help[37] ;
  args_info->temp_help = RNALfold_args_info_detailed_help[39] ;
  args_info->noTetra_help = RNALfold_args_info_detailed_help[40] ;
  args_info->dangles_help = RNALfold_args_info_detailed_help[41] ;
  args_info->noLP_help = RNALfold_args_info_detailed_help[43] ;
  args_info->noGU_help = RNALfold_args_info_detailed_help[45] ;
  args_info->noClosingGU_help = RNALfold_args_info_detailed_help[46] ;
  args_info->paramFile_help = RNALfold_args_info_detailed_help[47] ;
  args_info->nsp_help = RNALfold_args_info_detailed_help[49] ;
  args_info->energyModel_help = RNALfold_args_info_detailed_help[51] ;
