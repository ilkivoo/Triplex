...
case $2 in
  --help)           gengetopt --show-help --set-version=2.4.6 < $1.ggo | grep -v "in doubt" | grep -v "Comments should be sent";;
  --version)        echo 2.4.6;;
  --detailed-help)  gengetopt --show-detailed-help --set-version=2.4.6 < $1.ggo | grep -v "in doubt" | grep -v "Comments should be sent";;
esac
