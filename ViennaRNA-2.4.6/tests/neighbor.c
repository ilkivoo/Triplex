 ...
 * Edit the original source file "neighbor.ts" instead.
 */
...
START_TEST(test_vrna_neighbors)
{
#line 198
{
...
START_TEST(test_vrna_neighbors_with_shifts)
{
#line 230
{
...
START_TEST(test_vrna_perform_move)
{
#line 269
{
  char        *sequence   = "GGGAAACCCAACCUUU";
...
START_TEST(test_update_loop_indices_deletion)
{
#line 297
{
  char        *sequence   = "GGGAAACCCAACCUUU";
...
START_TEST(test_update_loop_indices_insertion)
{
#line 324
{
  //test insertion
...
START_TEST(test_update_loop_indices_insertion_after_insertion)
{
#line 350
{
...
START_TEST(test_update_loop_indices_insertion_within_insertion)
{
#line 377
{
...
START_TEST(test_vrna_neighbors_successive)
{
#line 405
{
  char                  *sequence   = "GGGAAACCCAACCUUU";
...
START_TEST(test_vrna_neighbors_successive_deletions_only)
{
#line 457
{
  char                  *sequence   = "GGGAAACCCAACCUUU";
...
START_TEST(test_vrna_neighbors_successive_insertions_only)
{
#line 509
{
  char                  *sequence   = "GGGAAACCCAACCUUU";
...
START_TEST(test_vrna_neighbors_successive_with_shifts)
{
#line 563
{
  char                  *sequence   = "GAAACCAACCU";
...
int main(void)
{
    Suite *s1 = suite_create("Neighbor");
    TCase *tc1_1 = tcase_create("Neighbor");
    SRunner *sr = srunner_create(s1);
    int nf;

    suite_add_tcase(s1, tc1_1);
    tcase_add_test(tc1_1, test_vrna_neighbors);
    tcase_add_test(tc1_1, test_vrna_neighbors_with_shifts);
    tcase_add_test(tc1_1, test_vrna_perform_move);
    tcase_add_test(tc1_1, test_update_loop_indices_deletion);
    tcase_add_test(tc1_1, test_update_loop_indices_insertion);
    tcase_add_test(tc1_1, test_update_loop_indices_insertion_after_insertion);
    tcase_add_test(tc1_1, test_update_loop_indices_insertion_within_insertion);
    tcase_add_test(tc1_1, test_vrna_neighbors_successive);
    tcase_add_test(tc1_1, test_vrna_neighbors_successive_deletions_only);
    tcase_add_test(tc1_1, test_vrna_neighbors_successive_insertions_only);
    tcase_add_test(tc1_1, test_vrna_neighbors_successive_with_shifts);
    tcase_add_test(tc1_1, test_rnamoves_noshift_lp);
    tcase_add_test(tc1_1, test_rnamoves_shift_lp);
    tcase_add_test(tc1_1, test_rnamoves_noshift_nolp);
    tcase_add_test(tc1_1, test_rnamoves_shift_nolp);
